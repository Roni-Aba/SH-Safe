...
\newcommand{\gruppenname}{Gruppe WSP3\_1}
\newcommand{\projektname}{Digitales Werkverzeichnis}
...
\title{
	...
	\gruppenname\\
	\vspace*{5mm}
	\includegraphics[scale=0.25]{img/group_pic.png}
}

\author{
	\begin{tabular}{r l@{\hspace{8\tabcolsep}} r} 
		Roni & Aba & \multirow{8}{*}{ \includegraphics{img/se-logo} } \\
		Collin & Flügel \\
		Jona & Giese \\
		Sebastian & Kempe \\
		Ricardo & Rieke \\
...
\begin{document}
	...
	\begin{tcolorbox}
		...
		\\\\
		%
		Tipps zur UML-Modellierung können im SE-Wiki\footnote{\url{https://cau-git.rz.uni-kiel.de/ifi-ag-se/public/teaching/-/wikis/home}} nachgelesen werden.
	...
	\chapter{Klassendiagramme}\label{chp:klassendiagramme-api}
	\thispagestyle{fancy}
	\input{kapitel/klassendiagramme-oder-api}
	
	\chapter{Sequenzdiagramme}\label{chp:sequenzdiagramme}
	\thispagestyle{fancy}
	\input{kapitel/sequenzdiagramme}

    \chapter{Glossar}\label{chp:gloasser}
    \thispagestyle{fancy}
